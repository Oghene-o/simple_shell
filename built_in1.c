#include "shell.h"
/**
 * _myhistory - always display the history list, one command by line, precede
...
/**
 * unset_alias - always set alias to string
...
/**
 * print_alias - always print an alias string
 * @node: the alias node
 *
 * Return: 0 on success, 1 on error
 */
...
/**
 * _myalias -to mimics the alias builtin (the man alias)
